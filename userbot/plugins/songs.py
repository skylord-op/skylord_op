...
# porting to SKYLORD-OP by @koi_nhi_apna ...
    ...
    async with bot.conversation(chat) as conv:
        ...
        try:
            ...
            if response.text.startswith("Sorry"):
                ...
                return await gaana.edit(f"web search complete no result found {song}")
            ...
            await gaana.edit(
                "```Please allow``` @FindmusicpleaseBot```to pm or dm and try again```"
            )

            return

        await gaana.edit("`SKYLORD Sending Your Music...wait!!! 😉😎`")
...
async def getmusic(so):
    ...
    async with bot.conversation(chat) as conv:
        ...
        try:
            ...
            await so.edit("Please allow @SongsForYouBot to pm or dm and try searching again🤐")
            return
    ...
    async with borg.conversation("@DeezLoadBot") as conv:
        try:
            ...
            await borg.send_file(
                event.chat_id,
                songh,
                caption="🔆**Here's the requested song!**🔆\n`Check out` [SKYLORD-OP user bot](https://t.me/SKYLORD-OP_help_chat)",
            )
            await event.delete()
        except YouBlockedUserError:
